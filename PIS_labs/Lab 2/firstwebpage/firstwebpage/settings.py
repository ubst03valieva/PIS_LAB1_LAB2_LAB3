...
SECRET_KEY = 'django-insecure-e1q8o__5!xhk0tuv4+ycze*8(j*rgpq25*_3b+%_zap1qhups^'
...
TEMPLATES = [
    {
        ...
        # Указываю директорию с шаблонами
        # os.path.join объединяет BASE_DIR с 'flatpages' для получения полного пути
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db_firstwebpage'),  # Устанавливаю имя файла БД
    }
}
